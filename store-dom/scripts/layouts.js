...
function renderizarNav(containerSelector,options){
    const navSelector = document.querySelector(containerSelector);
...
function renderizarFooter(containerSelector,options){
    const footerSelector = document.querySelector(containerSelector);
    const columnsContainer = footerSelector.querySelector(".columns-container");
...
function renderizarSearch(containerSelector){
    const searchSelector = document.getElementById(containerSelector);
    const searchInput = document.createElement("input");
    searchInput.setAttribute("type", "text");
    searchInput.setAttribute("placeholder", "Search");

    searchSelector.appendChild(searchInput);
}

renderizarSearch("search");
renderizarNav("#nav", options);
renderizarFooter("footer", options);
